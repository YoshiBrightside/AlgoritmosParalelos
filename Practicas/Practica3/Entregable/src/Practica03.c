...
*
* Para compilar: gcc Practica03.c -lm -o practica03.out -fopenmp
*/
...
int main(int argc, char** argv){
	...
	//crea el numero de hilos necesarios, el ancho de cada rectangulo y el total
	...
	#pragma omp parallel private(idHilo,ancho)
	{
		...
		double punto_y;
        double i;
		//cada hilo hace sus respectivos 5 rectangulos a lo chuntaro style
        for (i=0;i<5;i++){
